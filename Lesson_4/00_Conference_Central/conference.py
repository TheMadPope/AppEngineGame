...
# - - - Profile objects - - - - - - - - - - - - - - - - - - -
    ...
    @endpoints.method(CONF_GET_REQUEST, BooleanMessage,
            path='unregisterConference/{websafeConferenceKey}',
    ...
    def getConferencesToAttend(self, request):
        ...
        keys = [ndb.Key(urlsafe=wsck) for wsck in prof.conferenceKeysToAttend]
    ...
    #def filterPlayground(self, request):
		...
		# METHOD 2
		#q = Conference.query().\
		#filter(Conference.city=="Tokyo").\
		#filter(Conference.seatsAvailable >0).\
		#filter(Conference.seatsAvailable <10).\
